...
const placeholderVideos = [
  { id: 1, title: "Cliente feliz con su bouquet", thumbnail: "" },
  { id: 2, title: "Entrega sorpresa de rosas", thumbnail: "" },
  { id: 3, title: "Bouquet personalizado de 100 rosas", thumbnail: "" },
  { id: 4, title: "Arreglo especial para aniversario", thumbnail: "" },
  { id: 5, title: "Rosas pintadas con brillos", thumbnail: "" },
  { id: 6, title: "Bouquet gigante de 200 rosas", thumbnail: "" },
];
        ...
        <div className="relative">
          ...
          >
            {placeholderVideos.map((video, i) => (
              ...
              >
                <div className="relative aspect-[9/16] rounded-lg overflow-hidden bg-muted group cursor-pointer">
