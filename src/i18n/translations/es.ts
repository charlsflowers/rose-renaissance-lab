export const es = {
  ...
  home: {
    ...
    deliverySubtitle: "$20 tarifa fija para 0-5 millas. $1.60/milla de 5 a 87 millas. Recogida gratis en tienda.",
  ...
  contact: {
    ...
    hoursLine2: "Sáb 8AM–6PM | Dom 8AM–5PM",
  ...
  deliveryPage: {
    ...
    homeDelivery: "Envío a Domicilio",
    flatRate: "0–5 millas: $20 tarifa fija",
    perMile: "5–87 millas: $20 + $1.60 por milla adicional",
    example: "Ejemplo: envío de 10 millas = $20 + (5 × $1.60) = $28",
  ...
  faqPage: {
    ...
    faqs: [
      ...
      { q: "¿Cuánto cuesta el envío de flores en Miami?", a: "$20 tarifa fija para 0-5 millas. $1.60 por milla de 5 a 87 millas. Recogida gratis disponible en 7261 NW 12th Street, Miami FL 33126." },
  ...
  builder: {
    ...
    letters: "Letras",
    numbers: "Números",
    typeLetters: "Escribe letras (máx. 4)",
    typeNumbers: "Escribe números (máx. 4)",
    crown: "Corona",
    crownSmall: "Pequeña",
    crownLarge: "Grande",
    ...
    vase: "Florero",
    aiPreview: "Vista Previa IA",
    generatePreview: "Generar Vista Previa IA",
