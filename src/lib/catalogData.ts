...
export const categories: CategoryInfo[] = [
  ...
  { slug: 'cajas', title: 'Cajas', description: 'Rosas elegantes presentadas en cajas de lujo' },
  { slug: 'cestas', title: 'Cestas', description: 'Cestas artesanales repletas de flores frescas' },
  { slug: 'jarrones', title: 'Jarrones', description: 'Arreglos en jarrones de cristal premium' },
...
export const categoryProducts: Record<string, CatalogProduct[]> = {
  ...
  cajas: [
    { id: 'caj-1', name: 'Caja Clásica', description: 'Rosas premium en caja elegante negra', image: '', sizes: [{ label: 'Pequeño', price: 65 }, { label: 'Mediano', price: 95 }, { label: 'Grande', price: 140 }] },
    ...
    { id: 'caj-3', name: 'Caja Luxury', description: 'Caja de lujo con rosas preservadas', image: '', sizes: [{ label: 'Pequeño', price: 85 }, { label: 'Mediano', price: 125 }, { label: 'Grande', price: 180 }] },
  ],
  cestas: [
    ...
    { id: 'ces-2', name: 'Cesta Deluxe', description: 'Cesta premium con rosas y lirios', image: '', sizes: [{ label: 'Pequeño', price: 70 }, { label: 'Mediano', price: 100 }, { label: 'Grande', price: 150 }] },
  ...
  jarrones: [
    ...
    { id: 'jar-2', name: 'Jarrón Dorado', description: 'Arreglo elegante en jarrón dorado', image: '', sizes: [{ label: 'Pequeño', price: 85 }, { label: 'Mediano', price: 120 }, { label: 'Grande', price: 175 }] },
    { id: 'jar-3', name: 'Jarrón Vintage', description: 'Flores en jarrón de cerámica artesanal', image: '', sizes: [{ label: 'Pequeño', price: 75 }, { label: 'Mediano', price: 110 }, { label: 'Grande', price: 160 }] },
  ],
  osos: [
...
export const bouquetProducts: BouquetProduct[] = [
  ...
  { id: 'bq-round-3', name: 'Bouquet Blanco Puro', description: 'Ramo redondo de rosas blancas elegantes', image: '', color: 'Blanco', type: 'round' },
  // Heart
