...
export const landingPages: LandingPageData[] = [
  ...
  },
  {
    ...
    seo: {
      ...
      whyParagraph: "Wynwood is Miami's creative core — galleries, design studios, lofts, restaurants and the iconic Wynwood Walls. The flower deliveries we make here are different from any other Miami neighborhood: photoshoot florals for content creators, opening-night bouquets for gallery shows, statement arrangements for restaurants and lounges, and birthday surprises to lofts in the Wynwood Arts District. Our team knows the area's mix of creative spaces and residential buildings, and our atelier is a quick drive away.",
      zonesTitle: 'Areas we cover in Wynwood',
      zonesIntro: 'We deliver across Wynwood and the surrounding creative neighborhoods, including:',
      zones: [
        'Wynwood Walls and the gallery district along NW 2nd Avenue',
        'Wynwood Arts District lofts and live/work spaces',
        'Miami Design District (luxury retail and showrooms)',
        'Edgewater high-rises along Biscayne Boulevard',
        'Midtown Miami residential and shopping district',
        'Restaurants, lounges and event spaces around NW 23rd Street',
        'Studios and creative offices around NW 5th Avenue',
        'Allapattah border areas (on request)',
      ],
      occasionsTitle: 'Popular occasions in Wynwood',
      occasionsIntro: 'These are the most common reasons our Wynwood clients order flowers from us:',
      occasions: [
        'Photoshoot florals for content creators, brands and influencers',
        'Gallery opening bouquets and art event florals',
        'Restaurant and lounge weekly fresh flower programs',
        'Birthday and anniversary deliveries to Wynwood lofts',
        'Showroom and brand activation florals in the Design District',
        'Welcome bouquets for visiting artists and creatives',
      ],
      ...
      faqs: [
        {
          question: 'Do you deliver florals for photoshoots in Wynwood?',
          answer: 'Yes. We work regularly with photographers, content creators and brand teams in Wynwood. We can coordinate delivery to studios or shoot locations on the Walls strip, and we offer custom palettes designed specifically for camera. For recurring photoshoot florals or brand activations, contact us for a creator-friendly rate.',
        },
        {
          question: 'Can you deliver to galleries, restaurants and lounges in Wynwood?',
          answer: "Yes. We supply fresh florals to galleries (opening nights, exhibitions), restaurants and event spaces across Wynwood, the Design District and Midtown. For weekly fresh flower programs, please contact us so we can build a rotating program that fits your space's design.",
        },
        {
          question: 'Can you deliver to a loft or apartment in the Wynwood Arts District?',
          answer: 'Yes. We deliver to live/work lofts and residential buildings throughout the Wynwood Arts District. For loft buildings without a doorman, please include a contact phone number for the recipient so our courier can hand off the bouquet directly.',
        },
        {
          question: 'How much does delivery to Wynwood cost?',
          answer: 'Most Wynwood addresses fall right around our $20 flat-rate zone (0–5 miles from our NW 12th Street atelier). For Edgewater or Design District addresses slightly beyond 5 miles, the rate adds $1.60 per additional mile. Same-day delivery requires ordering before 3PM Miami time, with a 2-hour minimum prep. Delivery hours: Mon–Fri 8AM–7PM, Sat 8AM–6PM, Sun 8AM–5PM.',
        },
      ],
      internalLinksTitle: "If you're looking for flower delivery in nearby areas, we also serve:",
      internalLinks: [
      ...
      ctaLabel: 'Order Wynwood Flower Delivery',
  ...
  },
  {
    ...
    seo: {
      ...
      whyParagraph: "Miami Beach is a city of its own — South Beach hotels, Mid-Beach luxury condos, North Beach residential blocks, and the high-end resorts of Bal Harbour and Sunny Isles just beyond. The flower deliveries we make here are mostly for hotel guests, condo residents and special celebrations: anniversary surprises at the Setai or Faena, welcome bouquets for guests checking into the Fontainebleau or 1 Hotel, and birthday deliveries to oceanfront residences. Our team knows the building and hotel protocols across Miami Beach.",
      zonesTitle: 'Areas we cover in Miami Beach',
      zonesIntro: 'We deliver across all Miami Beach and the barrier-island neighborhoods, including:',
      zones: [
        'South Beach (SoBe) — Ocean Drive, Collins Avenue, Lincoln Road',
        'Mid-Beach — Faena District, the Fontainebleau, Eden Roc',
        'North Beach and Normandy Isle',
        'Sunset Harbour and Belle Isle / Venetian Islands',
        'Bal Harbour, Surfside and Bay Harbor Islands',
        'Star Island, Hibiscus Island and Palm Island (on request)',
        'Sunny Isles Beach (on request)',
        'Hotels: Setai, Faena, Fontainebleau, 1 Hotel, W South Beach, Loews, Edition, Delano',
      ],
      occasionsTitle: 'Popular occasions in Miami Beach',
      occasionsIntro: 'These are the most common reasons our Miami Beach clients order flowers from us:',
      occasions: [
        'Hotel guest welcome bouquets at the Setai, Faena, Fontainebleau and 1 Hotel',
        'Anniversary and romantic surprises to oceanfront condos',
        'Birthday deliveries to South Beach and Mid-Beach residences',
        'Engagement and proposal florals at hotel suites and rooftops',
        'Photoshoot florals on Ocean Drive, Faena Beach and rooftop pools',
        'Sympathy and get-well bouquets to Mount Sinai Medical Center',
      ],
      ...
      faqs: [
        {
          question: 'Do you deliver to hotels in South Beach and Mid-Beach?',
          answer: "Yes. We deliver regularly to all major Miami Beach hotels — Setai, Faena, Fontainebleau, 1 Hotel, W South Beach, Loews, Edition, Delano and many more. Just include the guest's full name and check-in date when ordering, and our courier coordinates handoff with the concierge per hotel policy.",
        },
        {
          question: 'Can you deliver to oceanfront condos and the Venetian Islands?',
          answer: "Yes. We deliver to oceanfront condo towers across South Beach, Mid-Beach and North Beach, plus the Venetian Islands, Belle Isle, Sunset Harbour and Bal Harbour. All major condo buildings accept floral deliveries through their doorman or concierge — we follow each building's specific protocol.",
        },
        {
          question: 'How much does delivery to Miami Beach cost?',
          answer: "Miami Beach addresses are typically 8–12 miles from our atelier, so most deliveries cost between $25 and $32: $20 for the first 5 miles plus $1.60 per additional mile. The exact cost depends on the specific address and is calculated at checkout.",
        },
        {
          question: 'What is the cutoff for same-day delivery to Miami Beach?',
          answer: 'Same-day delivery to Miami Beach requires placing your order before 3PM Miami time, with a 2-hour minimum preparation window. Orders placed after 3PM are scheduled for the next available delivery window. Delivery hours: Mon–Fri 8AM–7PM, Sat 8AM–6PM, Sun 8AM–5PM.',
        },
      ],
      internalLinksTitle: "If you're looking for flower delivery in nearby areas, we also serve:",
      internalLinks: [
      ...
      ctaLabel: 'Order Miami Beach Flower Delivery',
  ...
  },
  {
    ...
    seo: {
      ...
      whyParagraph: "Mother's Day (and Día de las Madres) is the busiest week of the year for flower delivery in Miami — and the week when generic wire-service bouquets fail most often. We handle Mother's Day differently: every arrangement is designed in our Miami atelier from roses sourced fresh that week, our delivery routes are planned by neighborhood the day before, and our team is fully bilingual to handle Spanish-speaking families across Hialeah, Doral, Miami Beach and Kendall. We recommend pre-ordering several days early so you can lock in your preferred delivery window.",
      zonesTitle: "Mother's Day delivery across Miami",
      zonesIntro: "We deliver Mother's Day bouquets to every Miami-Dade neighborhood, including:",
      zones: [
        'Brickell, Downtown Miami and Edgewater high-rises',
        'Miami Beach (South Beach, Mid-Beach, North Beach)',
        'Coral Gables and Pinecrest residential homes',
        'Wynwood, Design District and Midtown',
        'Doral and CityPlace Doral',
        'Hialeah and Hialeah Gardens (bilingual service)',
        'Kendall, West Kendall, Pinecrest and Palmetto Bay',
        'Aventura and Sunny Isles (on request)',
      ],
      occasionsTitle: "What makes a perfect Mother's Day bouquet",
      occasionsIntro: "Most popular Mother's Day choices from our Miami clients:",
      occasions: [
        'Soft Pink — classic, elegant, the most-ordered Mother\'s Day color',
        'Hot Pink Blush — bright and joyful, perfect for younger moms',
        'White roses — refined and timeless',
        'Mixed pastel bouquets — custom palette for moms who love color',
        '100 or 150 rose bouquets — for milestone birthdays falling close to Mother\'s Day',
        'Add-ons: handwritten card, ribbon with mom\'s name, butterflies or a small crown',
      ],
      ...
      faqs: [
        {
          question: "When should I order my Mother's Day bouquet?",
          answer: "We recommend pre-ordering 2–3 days in advance. Mother's Day is the busiest week of the year for flower deliveries in Miami, and same-day windows fill up fast — especially the morning slots most people prefer. If you place your order before 3PM Miami time on Mother's Day Sunday itself, same-day delivery is still available, but we can't guarantee a specific time slot.",
        },
        {
          question: "Do you deliver on Mother's Day Sunday?",
          answer: "Yes. We deliver every Sunday from 8AM to 5PM, including Mother's Day. We plan extra routes that weekend to handle volume, but pre-ordering several days ahead is the safest way to lock in your preferred window.",
        },
        {
          question: "What's the most popular Mother's Day bouquet?",
          answer: "Soft Pink is our most-ordered Mother's Day color, followed by Hot Pink Blush and white roses. Many clients also order custom mixed pastel bouquets through our builder, which lets you preview the bouquet with AI before ordering. Sizes range from 50 to 200 roses depending on your budget.",
        },
        {
          question: "How much does Mother's Day delivery cost?",
          answer: "Standard delivery rates apply: $20 flat for 0–5 miles and $1.60 per additional mile up to 87 miles total. There are no Mother's Day surcharges. Free in-store pickup is also available at 7261 NW 12th Street, Miami FL 33126.",
        },
      ],
      internalLinksTitle: 'Browse our Miami delivery pages by neighborhood:',
      internalLinks: [
        { label: 'Flower Delivery Brickell', slug: 'flower-delivery-brickell' },
        { label: 'Flower Delivery Hialeah', slug: 'flower-delivery-hialeah' },
        { label: 'Flower Delivery Miami Beach', slug: 'flower-delivery-miami-beach' },
      ...
      ctaLabel: "Shop Mother's Day Bouquets",
  ...
  },
  {
    ...
    seo: {
      ...
      whyParagraph: "Gender reveals deserve flowers that match the moment — fresh, photogenic, and exactly the right color. Most generic florists hand you a pre-stocked pink or blue arrangement; we build yours from scratch in our Miami atelier, so the pink is the exact pink you want (soft baby pink, hot pink, or rose pink) and the blue is the blue you want (sky blue, navy, or our signature painted blue). You can also order a custom palette through our AI bouquet builder and preview exactly what the arrangement will look like before placing the order. Same-day delivery is available across Miami when you order before 3PM.",
      zonesTitle: 'Gender reveal delivery across Miami',
      zonesIntro: 'We deliver gender reveal bouquets to every Miami-Dade neighborhood, including:',
      zones: [
        'Brickell, Downtown Miami and Edgewater (party venues and condos)',
        'Miami Beach hotels and oceanfront residences',
        'Coral Gables and Pinecrest family homes',
        'Wynwood, Design District and Midtown event spaces',
        'Doral and CityPlace Doral',
        'Hialeah and Hialeah Gardens (bilingual service)',
        'Kendall, West Kendall and Palmetto Bay',
        'Aventura and Sunny Isles (on request)',
      ],
      occasionsTitle: 'Popular gender reveal bouquet styles',
      occasionsIntro: 'Most-ordered styles for gender reveal parties in Miami:',
      occasions: [
        'Soft Pink — for "It\'s a girl!" reveals, classic and elegant',
        'Blue Sky bouquet — for "It\'s a boy!" reveals, our signature painted blue',
        '50/50 split bouquet — half pink, half blue, before the big reveal',
        'Custom mixed bouquet with AI preview — pick your exact shades',
        '100 or 150 rose bouquets for centerpieces or photo backdrops',
        'Add-ons: ribbons with the baby\'s name, butterflies, glitter finish',
      ],
      deliveryTitle: 'Gender reveal delivery information',
      deliveryParagraph: "We deliver across Miami-Dade up to 87 miles from our atelier. Delivery rate is $20 for the first 0–5 miles and $1.60 per additional mile. Every order needs a minimum of 2 hours of preparation. For same-day delivery, place your order before 3PM Miami time — orders placed after the cutoff are scheduled for the next available window. We recommend ordering at least 24 hours in advance for gender reveal parties so you can lock in a specific delivery window before guests arrive. Delivery hours are Monday to Friday 8AM–7PM, Saturday 8AM–6PM and Sunday 8AM–5PM. Free pickup is also available at 7261 NW 12th Street, Miami FL 33126. Full details on our shipping policy page.",
      faqTitle: 'Gender reveal flower FAQs',
      faqs: [
        {
          question: 'Can I order a half-pink, half-blue bouquet?',
          answer: 'Yes. You can order a custom split bouquet through our AI bouquet builder — choose 50/50 pink and blue roses, or any ratio you want. The AI preview shows you exactly what the arrangement will look like before you place the order.',
        },
        {
          question: 'How fresh and photogenic are your roses?',
          answer: "Our roses are sourced weekly from premium growers in Ecuador, Holland and Florida, and stored in cooled conditions until designed. They're built to look perfect on camera — important for gender reveal photos and videos. We also offer a glitter finish option that reads beautifully in flash and natural light.",
        },
        {
          question: 'Can you deliver before guests arrive at my party?',
          answer: "Yes. For gender reveal parties, we recommend ordering at least 24 hours in advance and selecting a specific delivery window so the bouquet arrives well before guests show up. You can pick a window within our delivery hours (Mon–Fri 8AM–7PM, Sat 8AM–6PM, Sun 8AM–5PM). Same-day delivery is also available for orders placed before 3PM Miami time.",
        },
        {
          question: 'How much does delivery cost across Miami?',
          answer: 'Delivery rate is $20 for the first 0–5 miles and $1.60 per additional mile, up to 87 miles total. The exact cost is calculated at checkout based on your delivery address. Every order needs a minimum of 2 hours preparation. Free in-store pickup is also available at 7261 NW 12th Street, Miami FL 33126.',
        },
      ],
      internalLinksTitle: 'Browse related collections:',
      internalLinks: [
      ...
      ctaLabel: 'Shop Gender Reveal Bouquets',
      areaServed: 'Miami, Florida',
    },
  },
  {
