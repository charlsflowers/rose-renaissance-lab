...
export const reviews: ReviewData[] = [
  // === BOUQUETS ===
  { id: "bq-1", name: "Mariana T.", rating: 5, text: "Un ramo enorme y precioso. Las rosas blancas estaban frescas y perfectas. Lo compré para decorar mi boda.", image: reviewPurezaBlanca, productLabel: "Pureza Blanca", category: "bouquets", cartData: { bouquetType: "round", color: "Blanco", roses: 75, price: 101 } },
  { id: "bq-2", name: "Carlos R.", rating: 5, text: "Le regalé este bouquet de rosas hot pink a mi novia por su cumpleaños y le encantó. Colores vibrantes y muy fresco.", image: reviewRosaIntenso, productLabel: "Rosa Intenso", category: "bouquets", cartData: { bouquetType: "round", color: "Hot Pink", roses: 150, price: 226 } },
  { id: "bq-3", name: "Laura M.", rating: 5, text: "Las rosas pink son un sueño. El resultado superó todas mis expectativas. Un bouquet enorme y precioso.", image: reviewTernuraInfinita, productLabel: "Ternura Rosa", category: "bouquets", cartData: { bouquetType: "round", color: "Pink", roses: 150, price: 226 } },
  { id: "bq-4", name: "Isabella N.", rating: 5, text: "Siempre quise un bouquet de 200 rosas moradas y este superó mis expectativas. ¡Una maravilla total!", image: review35, productLabel: "Encanto Morado", category: "bouquets", cartData: { bouquetType: "round", color: "Morado", roses: 200, price: 286 } },
  { id: "bq-5", name: "Ana P.", rating: 5, text: "Compré este bouquet de rosas naranjas para decorar un evento corporativo. Todos me preguntaron dónde lo conseguí.", image: reviewOcasoNaranja, productLabel: "Ocaso Naranja", category: "bouquets", cartData: { bouquetType: "round", color: "Naranja", roses: 100, price: 136 } },
  ...
  { id: "bq-7", name: "María G.", rating: 5, text: "Sorprendí a mi esposo con 200 rosas rojas por nuestro aniversario. No dejó de sonreír en todo el día. ¡Impresionante!", image: reviewPasionTotal, productLabel: "Pasión Total", category: "bouquets", cartData: { bouquetType: "round", color: "Rojo", roses: 200, price: 316 } },
  { id: "bq-8", name: "Mateo S.", rating: 5, text: "El azul de las rosas es muy intenso. Un detalle único que sorprendió a todos en la fiesta.", image: reviewCieloAzul, productLabel: "Cielo Azul", category: "bouquets", cartData: { bouquetType: "round", color: "Azul", roses: 100, price: 256 } },
  { id: "bq-9", name: "Diego G.", rating: 5, text: "Un bouquet completamente negro, súper elegante y exclusivo. Quedó espectacular en la decoración.", image: reviewNocheProfunda, productLabel: "Noche Profunda", category: "bouquets", cartData: { bouquetType: "round", color: "Negro", roses: 100, price: 256 } },
  ...
  { id: "bq-11", name: "Andrea C.", rating: 5, text: "Rosas hot pink, pink y blancas para mi boda. Fue el centro de todas las fotos. ¡Absolutamente mágico!", image: review34, productLabel: "Sinfonía Rosa", category: "bouquets", cartData: { bouquetType: "round", color: "Hot Pink, Pink y Blanco", roses: 150, price: 226 } },
  { id: "bq-12", name: "Diego F.", rating: 5, text: "Pedí 150 rosas amarillas y blancas para mi graduación. El bouquet era enorme y todos quedaron encantados.", image: reviewJardinPrimaveral, productLabel: "Jardín Primaveral", category: "bouquets", cartData: { bouquetType: "round", color: "Amarillo y Blanco", roses: 150, price: 226 } },
  { id: "bq-13", name: "Renata B.", rating: 5, text: "Las rosas lilas con blancas son una combinación divina. Lo pedí para un baby shower y fue el detalle perfecto.", image: reviewLilaSuave, productLabel: "Lila Suave", category: "bouquets", cartData: { bouquetType: "round", color: "Lila y Blanco", roses: 100, price: 136 } },
  { id: "bq-14", name: "Hugo M.", rating: 5, text: "Le regalé este bouquet de 175 rosas naranjas y amarillas a mi pareja. Los colores son espectaculares y duraron muchísimo.", image: reviewCitricoRefrescante, productLabel: "Cítrico Refrescante", category: "bouquets", cartData: { bouquetType: "round", color: "Naranja y Amarillo", roses: 175, price: 276 } },
  ...
  { id: "bq-23", name: "Valentina R.", rating: 5, text: "Me encantó este bouquet de 175 rosas azules y blancas. El contraste es precioso y la calidad es inmejorable.", image: reviewOceanoBlanco, productLabel: "Océano Blanco", category: "bouquets", cartData: { bouquetType: "round", color: "Azul y Blanco", roses: 175, price: 326 } },
  ...
  { id: "bq-31", name: "Miguel A.", rating: 5, text: "Pedí 200 rosas naranjas, hot pink y blancas para el cumpleaños de mi pareja. El tamaño es impresionante y los colores preciosos.", image: reviewAtardecerCalido, productLabel: "Atardecer Cálido", category: "bouquets", cartData: { bouquetType: "round", color: "Naranja, Hot Pink y Blanco", roses: 200, price: 286 } },
