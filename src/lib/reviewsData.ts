...
export const reviews: ReviewData[] = [
  ...
  { id: "bq-11", name: "Andrea C.", rating: 5, text: "Rosas hot pink y blancas para mi boda. Fue el centro de todas las fotos. ¡Absolutamente mágico!", image: review34, productLabel: "Amanecer Rosa y Blanco", category: "bouquets", cartData: { bouquetType: "round", color: "Hot Pink y Blanco", roses: 150, price: 226 } },
  ...
  { id: "bq-38", name: "Patricia G.", rating: 5, text: "El bouquet de hot pink, pink y blanco es precioso. Los tonos rosados combinan de maravilla.", image: review37, productLabel: "Sinfonía Rosa", category: "bouquets", cartData: { bouquetType: "round", color: "Hot Pink, Pink y Blanco", roses: 100, price: 136 } },
