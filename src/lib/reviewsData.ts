...
export const reviews: ReviewData[] = [
  ...
  { id: "bq-13", name: "Renata B.", rating: 5, text: "The lilac and white roses are a divine combination. I ordered it for a baby shower and it was the perfect touch.", image: reviewLilaSuave, productLabel: "Soft Lilac", category: "bouquets", cartData: { bouquetType: "round", color: "Lila y Blanco", roses: 100, price: 136, productImage: bqMixLilaBlancoImg } },
