...
export const reviews: ReviewData[] = [
  ...
  { id: "bq-2", name: "Carlos R.", rating: 5, text: "Le regalé este bouquet de rosas hot pink a mi novia por su cumpleaños y le encantó. Colores vibrantes y muy fresco.", image: reviewRosaIntenso, productLabel: "Rosa Intenso", category: "bouquets", cartData: { bouquetType: "round", color: "Hot Pink", roses: 75, price: 101 } },
